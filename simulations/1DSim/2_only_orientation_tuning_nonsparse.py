...
plt.title("MDS Embedding of Orientation Coding, Neural Response MDS (3D)")
plt.show()
...
plt.title("PCA Population Embedding of Orientation Coding, Neural Response (3D)")
plt.show()
...
plt.title("MDS Population Embedding of Orientation Coding, Neural Response (3D)")
plt.show()
